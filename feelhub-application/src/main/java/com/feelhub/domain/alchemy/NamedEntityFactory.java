...
public class NamedEntityFactory {
    ...
    private void addLanguage(final NamedEntity entity, final AlchemyJsonEntity alchemyJsonEntity) {
        if (alchemyJsonEntity.type.equalsIgnoreCase("Automobile")
                ...
                || alchemyJsonEntity.type.equalsIgnoreCase("NaturalDisaster")
                ...
                || alchemyJsonEntity.type.equalsIgnoreCase("RadioProgram")
                || alchemyJsonEntity.type.equalsIgnoreCase("RadioStation")
                || alchemyJsonEntity.type.equalsIgnoreCase("Technology")
                || alchemyJsonEntity.type.equalsIgnoreCase("TelevisionShow")
