...
public class TestsNamedEntityBuilder {
    ...
    public void canReturnGoodValuesForEntityWithoutDisambiguated() {
        ...
        assertThat(namedEntity.feelhubLanguage, is(FeelhubLanguage.forString(alchemyJsonEntity.language)));
    ...
    public void languageDependsOnType() {
        ...
        assertThat(namedEntity.feelhubLanguage, is(FeelhubLanguage.none()));
    }
