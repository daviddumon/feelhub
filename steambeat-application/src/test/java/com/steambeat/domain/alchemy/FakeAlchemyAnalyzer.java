...
public class FakeAlchemyAnalyzer extends AlchemyAnalyzer {
    ...
    public FakeAlchemyAnalyzer() {
        super(new FakeSessionProvider(), new NamedEntityProvider(new FakeJsonAlchemyLink(), new NamedEntityBuilder()), new KeywordService(new ReferenceService(new ReferenceFactory()), new KeywordFactory(), new FakeTranslator(), new UriManager(new FakeUriResolver())));
    }
}
