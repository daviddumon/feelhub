...
public class TestsAssociation {
    ...
    public void creationDateIsSet() {
        final Association association = new Association(new Uri("http://www.fake.com"), TestFactories.canonicalUriFinder());
    ...
    public void updatingChangesTheExpirationDateAndCanonical() {
        ...
        association.update(finder.thatFind(new Uri("http://www.fake.com")));

        assertThat(association.isAlive(), is(true));
        assertThat(association.getCanonicalUri(), is("http://www.fake.com"));
    }
}
