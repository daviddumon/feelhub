...
public class ApiTopicsNewResource extends ServerResource {

    @Inject
    public ApiTopicsNewResource(final TopicSearch topicSearch, final TopicDataFactory topicDataFactory) {
    ...
    public List<TopicData> getTopicDatas(final int skip, final int limit) {
        ...
        final List<Topic> topics = topicSearch
                .withSort("creationDate", Order.DESCENDING)
                .withLimit(limit)
                .withSkip(skip)
