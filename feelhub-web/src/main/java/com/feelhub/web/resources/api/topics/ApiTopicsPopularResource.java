...
public class ApiTopicsPopularResource extends ServerResource {

    @Inject
    public ApiTopicsPopularResource(final TopicSearch topicSearch, final TopicDataFactory topicDataFactory) {
    ...
    public List<TopicData> getTopicDatas(final int skip, final int limit) {
        ...
        final List<Topic> topics = topicSearch
                .withFeelings()
                .withSort("popularityCount", Order.DESCENDING)
                .withLimit(limit)
                .withSkip(skip)
