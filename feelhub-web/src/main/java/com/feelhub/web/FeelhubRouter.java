...
public class FeelhubRouter extends Router {
    ...
    private void attachAdminResources() {
        ...
        attachWithSecurity("/admin/topics/{topicId}/thumbnail", AdminTopicThumbnailResource.class);
    ...
    private void attachApiResources() {
        attach("/api/topics/search", ApiTopicsSearchResource.class);
        attach("/api/topics/textsearch", ApiTopicsFullTextSearchResource.class);
        ...
        attach("/api/topic/{topicId}", ApiTopicResource.class);
        attach("/api/user/bookmarkletshow", ApiUserBookmarkletShow.class);
